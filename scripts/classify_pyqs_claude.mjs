...
if (!apiKey) {
  console.error("❌ ERROR: ANTHROPIC_API_KEY is missing from .env.local!");
  console.error("Please add your Claude API key to .env.local like this:");
...
async function run() {
  console.log("🚀 Starting PYQ Classification Cleanup using Claude AI...");

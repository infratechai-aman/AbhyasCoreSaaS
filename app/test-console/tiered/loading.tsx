    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-[#0a1628] to-slate-950 flex items-center justify-center">
      <div className="flex flex-col items-center gap-4">
        ...
        <div className="text-center">
          <p className="text-white/80 font-semibold text-sm">Preparing your mock test...</p>
          <p className="text-white/40 text-xs mt-1">Generating tiered simulation questions</p>
        </div>
      </div>
    </div>
  );
